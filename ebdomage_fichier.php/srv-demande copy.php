...
$stmt_stats = $conn->prepare("
    ...
    WHERE artisan_id = ? AND statut = 'terminée'
");
$stmt_stats->bind_param("i", $artisan_id);
$stmt_stats->execute();
$total_projets = $stmt_stats->get_result()->fetch_assoc()['total'];

// Nombre de clients uniques
$stmt_clients = $conn->prepare("
    SELECT COUNT(DISTINCT client_id) as total FROM demandes 
    WHERE artisan_id = ?
");
$stmt_clients->bind_param("i", $artisan_id);
$stmt_clients->execute();
$total_clients = $stmt_clients->get_result()->fetch_assoc()['total'];

// Moyenne des notes
$stmt_note = $conn->prepare("
    SELECT ROUND(AVG(note), 1) as moyenne, COUNT(*) as nb_avis 
    FROM avis WHERE artisan_id = ?
");
$stmt_note->bind_param("i", $artisan_id);
$stmt_note->execute();
$stats_avis = $stmt_note->get_result()->fetch_assoc();
$moyenne_note = $stats_avis['moyenne'] ?? 0;
$nb_avis = $stats_avis['nb_avis'] ?? 0;
   ...
   <section class="about section-padding">
                ...
                <div class="about-thumb">
                    <div class="row">
                        <div class="col-lg-6 col-6 featured-border-bottom py-2">
                            <strong class="featured-numbers" data-valeur="<?php echo $total_projets; ?>" data-suffix="+">0+</strong>
                            <p class="featured-text">Projets terminés</p>
                        </div>

                        <div class="col-lg-6 col-6 featured-border-start featured-border-bottom ps-5 py-2">
                            <strong class="featured-numbers" data-valeur="<?php echo $total_clients; ?>" data-suffix="">0</strong>
                            <p class="featured-text">Clients servis</p>
                        </div>

                        <div class="col-lg-6 col-6 pt-4">
                            <strong class="featured-numbers" data-valeur="<?php echo $moyenne_note > 0 ? $moyenne_note * 10 : 0; ?>" data-suffix="/5" data-diviser="10">0/5</strong>
                            <p class="featured-text">Note moyenne</p>
                        </div>

                        <div class="col-lg-6 col-6 featured-border-start ps-5 pt-4">
                            <strong class="featured-numbers" data-valeur="<?php echo $nb_avis; ?>" data-suffix="">0</strong>
                            <p class="featured-text">Avis reçus</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="container mt-5">
        ...
        <?php if (isset($_SESSION['utilisateur_id']) && $_SESSION['role'] === 'client'): ?>
            ...
            <div class="card text-white p-4 rounded" style="background-color:#c0392b; border-left:5px solid #1a5c2a;">
                <form id="form-avis">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="commentaire" id="commentaire" rows="4" placeholder="Votre avis..." required style="width:100%; background-color:#1a5c2a; color:white;
